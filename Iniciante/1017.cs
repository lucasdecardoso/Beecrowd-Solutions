...
Para isso, ele gostaria que você o auxiliasse através de um simples programa. Para efetuar o cálculo, deve-se fornecer o tempo gasto na viagem (em horas) e a velocidade média durante a mesma (em km/h). Assim, pode-se obter distância percorrida e, em seguida, calcular quantos litros seriam necessários. 
...
class URI 
{
    ...
    { 
        ...
        int distanciaPercorrida = tempoGasto * velocidadeMedia; //850km
        double litrosNecessarios = distanciaPercorrida / 12.0; //o carro faz 12km por litro 
